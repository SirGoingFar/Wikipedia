...
class HistoryArticleRecyclerViewAdapter(
    private val context: Context,
    private var articleList: ArrayList<WikiResult.WikiPage>,
    private val listener: OnHistoryArticleClickListener
) :
    RecyclerView.Adapter<HistoryArticleRecyclerViewAdapter.ViewHolder>() {
    override fun onCreateViewHolder(container: ViewGroup, p1: Int): ViewHolder {
        return ViewHolder(LayoutInflater.from(context).inflate(R.layout.item_article, container, false))
    }
    ...
    override fun onBindViewHolder(itemViewHolder: ViewHolder, p1: Int) {
        ...
        itemViewHolder.container.setOnClickListener {
            listener.onHistoryArticleClick(
    ...
    interface OnHistoryArticleClickListener {
        fun onHistoryArticleClick(position: Int, article: WikiResult.WikiPage)
    }
}